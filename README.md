...
6. Change the URL in the browsers address field to http://localhost:8080/list and verify that a user named "CSRF" with the address "vulnerability" has signed up
